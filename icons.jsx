// Minimal icon library (Lucide-style stroke icons)
const I = (path, vb = "0 0 24 24") => ({ size = 16, color = "currentColor", strokeWidth = 1.75, style }) => (
...
const Icons = {
  ...
  Eye2: I(<><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z" /><circle cx="12" cy="12" r="3" /></>),
  ...
  Logo: ({ size = 30 }) => (
    <svg width={size} height={size} viewBox="0 0 30 30" fill="none">
      <rect width="30" height="30" rx="8" fill="url(#g)" />
      <path d="M5 16h3l2-5 3 8 2.5-6L17 16h8" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <defs><linearGradient id="g" x1="0" y1="0" x2="30" y2="30"><stop stopColor="#3B82F6" /><stop offset="1" stopColor="#1D4ED8" /></linearGradient></defs>
    </svg>
  ),
};
